<div class="lenta__item lenta-post" data-user="<?= $user['user_id'] ?>" data-post="<?= $idPost ?>">
    <div class="lenta-post__main-header">
        ...
        <a href="/editPost?user_id=<?= $user['user_id'] ?>&post_id=<?= $idPost ?>" class="lenta-post__edit">
    ...
    <div class="lenta-post__photos photos">
        ...
        <div class="lenta-post__photo-reaction" id="lenta-post__photo-reaction-<?= $user['user_id'] ?>-<?= $idPost ?>">
            <img src="images/icons/heart.png" alt="heart">
            <p class="reaction-text"><?= $post['likes'] ?></p>
        </div>
    </div>
