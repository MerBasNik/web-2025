...
<body>
    <div class="loginpage">
        ...
        <div class="loginpage__inner">
            <img class="loginpage__img" src="/images/mainphoto.png" alt="logo" width="462" height="501">
            <form class="loginpage__form form">
                <div class="form__mail">
                    <label class="form__label" for="email">Электропочта</label>
                    <input class="form__input" type="email" name="email" id="email" required>
                    <label class="form__label_pass" for="email">Введите электропочту в формате ****@******</label>
                </div>
