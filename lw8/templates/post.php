<div class="lenta__item">
    <div class="lenta__item_header">
        <div class="lenta__item_info">
            <img class="lenta__item_ava" src="<?= htmlspecialchars($user['avatar']) ?>" alt="avatarka" width="32">
            <p class="lenta__item_name"><?= htmlspecialchars($user['name']) ?></p>
        </div>
        <img src="images/icons/edit.png" alt="edit">
    </div>
    <div class="lenta__item_photo">
        <img class="photo" src="<?= htmlspecialchars($post['image']) ?>" alt="img_post" width="474">
